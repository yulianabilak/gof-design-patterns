...
import com.bilak.creational.abstractfactory.subscriptions.vip.VipPassSubscription;
import com.bilak.creational.abstractfactory.subscriptions.vip.VipTimedSubscription;
import com.bilak.creational.abstractfactory.subscriptions.vip.VipUnlimitedSubscription;
 ...
 * @since 9/19/2022 - 21.54
 **/
public class VipSubscriptionFactory implements SubscriptionFactory {
    @Override
    public PassSubscription createPassSubscription(int passes, LocalDateTime dateFrom) {
        ...
        return new VipPassSubscription(passes, dateFrom, dateFrom.plusDays(1));
    }
